	...
	<div class="contact">
		<div class="container">
			<div class="agile-contact-form">
				...
				<img src="images/5.jpg" alt="" height="350px" width="500px">
					</div>
				</div>
				<div class="col-md-6 contact-form-right">
					...
					<div class="agileinfo-contact-form-grid">
						<form action="#" method="post" name="login">
							...
							<br>
							<div class="forgot">
                                                            <a style="color: #000;" href="forgot-password.php">Forgot Password?</a>
                                                        </div>
                                                        <br>
				...
				<div class="col-md-6 contact-form-right">
					 <div class="forgot">
                                                            <a style="color: #000;" href="signup.php">Register Yourself</a>
                                                        </div>
